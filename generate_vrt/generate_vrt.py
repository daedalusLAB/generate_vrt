        ...
        for sent in doc.sents:
            ...
            for token in sentence_doc:
                ...
                token_info = {
                    ...
                    "children": "|".join([child.text for child in token.children]) if token.children else "",
                    "lefts": "|".join([child.text for child in token.lefts]) if token.lefts else "",
                    "rights": "|".join([child.text for child in token.rights]) if token.rights else "",
